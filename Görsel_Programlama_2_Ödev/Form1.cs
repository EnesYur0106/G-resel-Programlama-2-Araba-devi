...
namespace Görsel_Programlama_2_Ödev
{
    public partial class Form1 : Form
    {
        ...
        public List<Car> Cars = new List<Car>()
        {
            new Car()
            {
                ...
                Kasa_Tipi = "sedan",
                Durum = "Sıfır",
                Açıklama = "Alman mükemmelliyetciliği",
        ...
        void ListeAracGüncelleme(ListViewItem aItem, Car car)
        {
            ...
            aItem.SubItems[7].Text = car.Durum;
            aItem.SubItems[8].Text = car.Açıklama;
    ...
    public class Car
    {
        [Category("Araç Bilgisi"), DisplayName("Plaka"), Description("Aracın Plakasını Giriniz")]
        public string Plaka { get; set; }
        [Category("Araç Bilgisi"), DisplayName("Marka"), Description("Aracın Markasını Giriniz")]
        public string Marka { get; set; }
        [Category("Araç Bilgisi"), DisplayName("Model"), Description("Aracın Modelini Giriniz")]
        public string Model { get; set; }
        [Category("Araç Bilgisi"), DisplayName("Yakıt"), Description("Aracın Yakıt Türünü Giriniz")]
        public string Yakıt { get; set; }
        [Category("Araç Bilgisi"), DisplayName("Renk"), Description("Aracın Rengini Giriniz")]
        public string Renk { get; set; }
        [Category("Araç Bilgisi"), DisplayName("Vites"), Description("Aracın Kaç Vites Olduğunu Giriniz")]
        public string Vites { get; set; }
        [Category("Araç Bilgisi"), DisplayName("Kasa Tipi"), Description("Aracın Kasa Tipini Giriniz")]
        public string Kasa_Tipi { get; set; }
        [Category("Araç Bilgisi"), DisplayName("Durum"), Description("Araç Durumunu Yapınız")]
        public string Durum { get; set; }
        [Category("Araç Bilgisi"), DisplayName("Açıklama"), Description("Araç Hakkında Açıklama Yapınız")]
